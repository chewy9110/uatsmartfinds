...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
       ...
       <div class="btn-group dropstart">
           <button class="btn dropdown-toggle nav-link" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navbarDropdown">
           </button>
           <div class="dropdown-menu navbarDropdown" aria-labelledby="dropdownMenuButton">
             <li><a class="dropdown-item" href="member.html">Member's page</a></li>
             <li><a class="dropdown-item" href="watchlist.html">My Watchlist</a></li>
             <li><a class="dropdown-item" href="msgInbox.html">My Messages</a></li>
             <li><a class="dropdown-item" href="javascript:alert('Future enhancement feature.');">Profile</a></li>
             <li><a class="dropdown-item" href="javascript:alert('Future enhancement feature.');">Setting...</a></li>
