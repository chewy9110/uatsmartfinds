...
// })
const navContent = `
 <nav class="navbar navbar-expand-lg navbar-dark bg-color fixed-top" style="background-color: #97973c;">
 
 <header class="fixed-top p-0">
  <div class="container-fluid navbar-index">  
    <nav class="navbar navbar-expand-lg navbar-dark">
     <a class="navbar-brand me-5" href="index.html" style="background-color: #eee8d0; border-radius: 8px;margin: 5px;">
   ...
   <div class="input-group w-50 mx-auto d-flex d-none d-md-flex d-lg-none d-xl-flex d-lg-none d-xl-flex d-xl-none d-xxl-none" style="align-content: center;"">
     ...
     title="Future enhancement feature.."  data-bs-toggle="popover" data-bs-boundary="window" data-bs-placement="left" data-bs-trigger="hover" data-bs-content="Under Construction">Search</button>
   </div>
